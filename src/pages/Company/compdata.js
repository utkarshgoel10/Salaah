...
export const compdata = [
  {
    id: 1,
    mentors: (<Mentors name="Sameeksha Agarwal" img="https://drive.google.com/uc?export=view&id=1Fp11f6mutYB4msTcQqkuDxv8f71foHoB" link="https://www.linkedin.com/in/shreyansh-shukla-38842b187" />),
    company: "Cisco",
    cover: IMG1,
    ...
    about: (
      <div>
        The top supplier of goods, equipment, and networking-related services
        worldwide is <b> Cisco Systems. </b> Two Stanford University scientists
        founded the business in 1984 after discovering a simpler method of
        integrating numerous distinct computer systems. With thousands of
        employees dispersed over more than 115 countries, Cisco Systems, whose
        first product was sold in 1986, is today a multinational corporation.
        Today, Cisco provides networking solutions to a wide range of service
  ...
  {
    id: 2,
    mentors: (<Mentors name="Shreyansh Shukla" img="https://drive.google.com/uc?export=view&id=1Bk266gmynWUZmP2BZCY8s2NVoMemLTmQ" link="https://www.linkedin.com/in/shreyansh-shukla-38842b187" />),
    company: "Amazon",
    cover: IMG2,
    alum__img: "",
    alum__name: "",
...
Amazon is recognised for its massive industry disruptions brought about by technology innovation and size. Being the largest online retailer, provider of AI assistants, and cloud computing platform in the world, Amazon employs over six lakh people, of whom more than 50,000 are Indians. As a result of it being the largest Internet company in the world in terms of revenue at the moment, Amazon has the greatest worldwide brand valuation.
  ...
  {
    id: 3,
    mentors: (<Mentors name="Aarushi Rai" img="https://drive.google.com/uc?export=view&id=1cr9C3kducCWZsfvqJS6TgVg2Z9jMwvro" link="https://www.linkedin.com/in/aarushi-rai-0a176a1a7/?originalSubdomain=in" />),
      ...
      <div>
        ...
        <ul>
          <li>
            ...
            <b>• Verbal:</b> This section is related to Reading Comprehension. You
            must practise the topics listed below in order to answer more
  ...
  {
    id: 5,
    mentors: (<Mentors name="Anshita Yadav" img="https://drive.google.com/uc?export=view&id=1psE2RSinJb23jt-EKBgJ4fhzYF6ipa9T" link="https://www.linkedin.com/in/anshita-yadav-a4748a213/" />),
    company: "Synopsys",
    cover: IMG5,
    alum__img: "",
    alum__name: "",
